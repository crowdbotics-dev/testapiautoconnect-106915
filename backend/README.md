...
## Project Structure
    ...
    ├── testapiautoconnect_106915  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_106915`
...
2. Clone this repo and `cd testapiautoconnect_106915`
